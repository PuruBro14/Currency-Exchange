...
export default function Convert() {
  ...
  const handleAddMore = (e) => {
    ...
    if (existingEntryIndex === -1) {
      ...
      if(currentState=="Buy" && ConvertTableEntries?.length===1){
        toast.error("You have already added currency");
         setConvertFormValue({
          amount: "",
          from: "",
          fromImg: "",
      ...
      if (
        ...
        updateLocalStorage([{amount:convertFormValue.amount,from:convertFormValue.from,to:convertFormValue.to,currentRate:convertFormValue.currentRate,total:convertFormValue.total}]);
...
console.log('convertFormValue',convertFormValue);
